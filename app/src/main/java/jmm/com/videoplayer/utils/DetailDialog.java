...
public class DetailDialog extends Dialog implements
    ...
    TextView txt_dialog_folder, txt_dialog_size, txt_dialog_resolution, txt_dialog_location, txt_dialog_date, txt_dialog_duration;
String folder,size,resolution,location,date,duration;
